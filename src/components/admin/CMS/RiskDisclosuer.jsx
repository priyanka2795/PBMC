...
export default function RiskDisclosuer() {
    ...
    async function GetContent() {
        try {
            ...
            console.log(riskDataDetails);
            setGetDetails(riskDataDetails)
        } catch (error) {
            console.log(error);
        }
    }
    ...
    function Update() {
        ...
        try {
            axios.put(`${process.env.REACT_APP_BASE_URL}/admin/updateRiskData/6470895dc450f6dcbdc69350`, data).then((e) => {
                // console.log(e.data)
